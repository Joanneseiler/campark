...
router.get('/profile', (req, res, next) => {
    ...
    .then((user) => {
      res.render('user/profile', {title: req.user.username, username: req.user.username, country: req.user.country, profilePic: req.user.profilePic, placesAdded: user.placesAdded, placesVisited: req.user.placesVisited});
    })
    .catch((err) => {
      next(err)
    })
